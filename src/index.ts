 ...
 */
export function readable(key: string, value: string, start: StartStopNotifier<string>): Readable<string> {
    return {
 ...
 * @param {StartStopNotifier=}start start and stop notifications for subscriptions
 */
export function writable(key: string, value: string, start: StartStopNotifier<string> = noop): Writable<string> {
 ...
 */
export function derived<S extends Stores>(
    key: string,
    stores: S,
